  ...
  return (
    <div className="w-[1500px] h-[800px] bg-[#191919] text-[#ffffff] relative">
      ...
      <div className="p-8">
        ...
        <ScrollArea type="always" className="h-[630px] max-w-[1250px] mx-auto ">
          <section className="mb-3">
            ...
            <div className=" text-[#5C5C5C]">
              ...
              <p className="text-sm leading-relaxed">
                1.3 Үйлчилгээний нөхцөл нь "entertainment.mn" цахим хуудас болон
                бусад төхөөрөмжөөр нэвтрэн "entertainment.mn" цахим хуудсанд
                үйлчилгээ авахад нэгэн адил үйлчилнэ.
              </p>
            </div>
          </section>
          ...
          <section className="mb-3">
            ...
            <div className=" text-[#5C5C5C]">
              <p className="text-sm leading-relaxed ">
                2.1 "entertainment.mn" цахим хуудасны хэрэглэгчийн бүртгэл (LOG
                IN-&gt;SIGN UP) хэсэгт та өөрийн утасны дугаар, и-мэйл хаяг дээр
                суурилж бүртгэл хийнэ. Ингэхдээ "entertainment.mn" цахим
                хуудаснаас өгсөн заавpын дагуу и-мэйл хаягт ирсэн баталгаажуулах
                кодыг оруулсны дараа өөрийн нууц кодыг үүсгэж бүртгүүлэх
                шаардлагатай.
              </p>
              <p className="text-sm leading-relaxed">
          ...
          <section className="mb-3">
            ...
            <div className=" text-[#5C5C5C]">
              <p className="text-sm leading-relaxed">
                ...
                ашиглахыг "entertainment.mn" цахим хуудсанд цахимаар зөвшөөрсөн
                болно.
              </p>
              <p className="text-sm leading-relaxed">
                3.2 Хэрэглэгчийг таньж мэдэх, баталгаажуулах зорилгоор
                "entertainment.mn" цахим хуудасны хүсэлтээр өөрийн, и-мэйл хаяг,
                гар утасны дугаар баталгаажуулахыг хүлээн зөвшөөрсөн болно.
              </p>
            </div>
          </section>
          ...
          <section className="mb-3">
            ...
            <div className=" text-[#5C5C5C]">
              <p className="text-sm leading-relaxed">
                ...
                "entertainment.mn" цахим хуудасны төлбөрийн хэрэгслүүдээр төлөх
                боломжтой. Хэрэглэгчээс сонгосон суудал болон өрөөний нийт үнийн
                дүнг шилжүүлснээр захиалга баталгаажна. Захиалгыг хүлээлгийн
                хугацаа болох 5 минутад баталгаажуулах шаардлагатай бөгөөд
                хугацаа хэтэрсэн тохиолдолд таны сонгосон суудал болон өрөө
                нээлттэй төлөвт автоматаар шилжиж баталгаажуулалт амжилтгүй
                болно.
              </p>
              <p className="text-sm leading-relaxed">
                4.2 Захиалгын и-баримтыг "Энтертайнмент Кочинг Групп" ХХК Монгол
                Улсын хууль тогтоомжийн дагуу хэрэглэгчид олгоно.
              </p>
            </div>
          </section>

          <section className="mb-3">
            <h2 className="text-base font-medium mb-3">ТАВ. ЗАХИАЛГА ЦУЦЛАХ</h2>
            <div className=" text-[#5C5C5C]">
              <p className="text-sm leading-relaxed">
                5.1 Хэрэглэгч нь сонгосон суудал болон өрөөний мэдээлэлтэй
                сайтар танилцаж, захиалгаа давхар нягтлах үүрэгтэй бөгөөд
                захиалгын төлбөрийг төлсөн тохиолдолд буцаах, цуцлах боломжгүй.
              </p>
            </div>
          </section>
