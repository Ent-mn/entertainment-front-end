...
const NewsFeed2 = () => {
  ...
  const likes = 23;
  return (
    <div className="px-52 py-20 dark:bg-[#121212] bg-[#F3F3F3] text-[#121212] dark:text-[#F3F3F3]">
      <div className="text-left py-2 ">
        ...
        <p className="text-xs text-gray-600 dark:text-gray-400">
          Тэгээд одоо яахав дээ гоё юм чинь үнэтэй шдээ. Үнэтэй юманд дуртай лаг
          юманд дуртай л биз дээ.{" "}
          <Dialog>
      ...
      <img src="/image copy 9.png" className="w-full h-[500px]  " />
      <CardFooter className="flex justify-between p-4">
        <div className="flex gap-4">
          <Button
            variant="ghost"
            size="sm"
            className="flex items-center gap-1 dark:bg-[#121212] bg-[#F3F3F3] text-[#121212] dark:text-[#F3F3F3]"
        ...
        <div className="flex">
          <Button
            variant="ghost"
            size="sm"
            className="dark:bg-[#121212] bg-[#F3F3F3] text-[#121212] dark:text-[#F3F3F3]">
