...
const RestLogin = () => {
  ...
  return (
    <div>
      <div className="flex h-[802px] w-[587px] items-center justify-center bg-[#f3f3f3] p-4">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center">
            <h1 className="text-4xl font-medium text-[#161616]">Нэвтрэх</h1>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                className="h-5 w-5 border-[#828282] data-[state=checked]:bg-[#fa742a] data-[state=checked]:border-[#fa742a]"
              />
              <label htmlFor="terms" className="text-[#676767] text-base">
                I agree to the
              </label>
            </div>
            ...
            <div className="text-center">
              <Link
                href="#"
                className="text-[#7e7e7e] text-base hover:underline"
              >
                Нүүц үг сэргээх
              </Link>
            </div>
